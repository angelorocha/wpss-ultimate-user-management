jQuery(function(o){let s=!1;var e=o(".wpss-menage-admin-menus");let t=o(".role-editor-messages");var n=o("#select-all");let a=o("body");o("#wpss-roles-list").select2(),e.on("submit",function(e){e.preventDefault(),s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"menage_admin_menu_options_action",nonce:wpss_user_management_object.nonce,wpss_admin_menus:o(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){t.removeClass("d-none").addClass("success").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}).error(function(e){t.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),t.on("click",function(){o(this).addClass("d-none")}),n.on("click",function(){o(this).is(":checked")?o(".pages-list").find("input:checkbox").prop("checked",!0):o(".pages-list").find("input:checkbox").prop("checked",!1)});e=o(".form-roles"),n=o(".role-delete");let r=o(".role-delete-confirm-msg"),l=o(".table-container"),i=!1,c=!1,d=!1,u=(n.each(function(){o(this).on("click","span.wpss-delete-current-role",function(){i=o(this).attr("data-role-name"),c=o(this).attr("data-role-id"),d=o("#role-"+c),r.addClass("show-box"),r.find(".role-name > strong").text(i),o(".table-roles").addClass("move-left"),l.outerHeight()<r.outerHeight()&&l.animate({height:r.outerHeight()},200)})}),r.on("click",".confirm-delete",function(){s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_remove_role_action",nonce:wpss_user_management_object.nonce,role_id:c,role_name:i},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){t.removeClass("d-none").addClass("success").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),d.remove(),r.removeClass("show-box"),o(".table-roles").removeClass("move-left"),l.removeAttr("style")}).error(function(e){t.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),r.on("click",".cancel-delete",function(){r.removeClass("show-box"),o(".table-roles").removeClass("move-left")}),e.on("submit",function(e){e.preventDefault(),s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_add_roles_action",nonce:wpss_user_management_object.nonce,role:o(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){t.removeClass("d-none").addClass("success").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),setTimeout(function(){location.reload()},2e3)}).error(function(e){t.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),o("#wpss-user-select").select2(),null),m=o(".user-details-container"),p=(a.on("click",".wpss-user-edit-link",function(){null===(u=o(this).attr("data-user-id"))||""===u||s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_get_user_details_action",nonce:wpss_user_management_object.nonce,user_id:u},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){m.removeClass("d-none").find("div").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),o("html, body").animate({scrollTop:a.find("#user-details-container").offset().top},1e3)}).error(function(e){m.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),o(".wpss-user-select").on("change","#wpss-user-select",function(){null===(u=o(this).val())||""===u||s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_get_user_details_action",nonce:wpss_user_management_object.nonce,user_id:u},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){m.removeClass("d-none").find("div").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}).error(function(e){m.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),a.on("submit",".wpss-add-role-to-user",function(e){e.preventDefault(),null===u||""===u||s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_set_user_roles_action",nonce:wpss_user_management_object.nonce,user_id:u,user_roles:o(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){""!==e?t.removeClass("d-none").addClass("success").html(e):t.removeClass("d-none").addClass("success").html(wpss_user_management_object.i18n.no_changes_made)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),o('.wpss-add-role-to-user input[type="checkbox"]').each(function(){if(o(this).is(":checked")){let e=o(this).val(),s=o(this).parent().text();o(".table-user-roles tbody tr").each(function(){o(".user-role-"+e)[0]||o(this).parent().append('<tr class="user-role-'+e+'"><td>'+s+"</td></tr>")})}else o(".table-user-roles tbody").find(".user-role-"+o(this).val()).remove()})}).error(function(e){m.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),o("#wpss-role-select").select2(),null),_=o(".wpss-role-caps-container");o(".wpss-role-select").on("change","#wpss-role-select",function(){null===(p=o(this).val())||""===p||s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_get_role_capabilities_action",nonce:wpss_user_management_object.nonce,role_caps:p},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){_.removeClass("d-none").find("div").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),o(".caps-container").each(function(){o(this).on("click",'strong input[type="checkbox"]',function(){o(this).is(":checked")?o(this).closest("ul").find('input[type="checkbox"]').prop("checked",!0):o(this).closest("ul").find('input[type="checkbox"]').prop("checked",!1)})})}).error(function(e){_.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),a.on("submit",".wpss-add-caps-to-role",function(e){e.preventDefault(),s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_set_capabilities_to_role_action",nonce:wpss_user_management_object.nonce,role:p,capabilities:o(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){""!==e?t.removeClass("d-none").addClass("success").html(e):t.removeClass("d-none").addClass("success").html(wpss_user_management_object.i18n.no_changes_made)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}).error(function(e){t.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),a.on("submit",".wpss-widgets-tab form#wpss-widgets-permissions",function(e){e.preventDefault(),s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"save_widget_options",nonce:wpss_user_management_object.nonce,wpss_widgets:o(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){a.find(".wpss-widget-messages").html(`<div class="role-editor-messages success">${e}</div>`),a.find(".role-editor-messages").on("click",null,function(){o(this).addClass("d-none")})}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}))}),a.on("submit",".wpss-widgets-tab form#wpss-individual-widgets-permissions",function(e){e.preventDefault(),s||(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"save_individual_widgets_permissions",nonce:wpss_user_management_object.nonce,individual_widgets:o(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){a.find(".wpss-widget-messages").html(`<div class="role-editor-messages success">${e}</div>`),a.find(".role-editor-messages").on("click",null,function(){o(this).addClass("d-none")})}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}))}),a.on("keyup",".cap-filter",function(){let e=o(this).val(),s=0;o(this).next("div").find("li").each(function(){o(this).text().search(new RegExp(e,"i"))<0?(o(this).hide(),o(this).parent().css("border-bottom","none").css("margin",0).css("padding",0).css("flex","inherit")):(o(this).show(),o(this).parent().removeAttr("style"),s++)})}),a.on("click",".wpss-open-user-role-editor",function(e){e.preventDefault();e=o(this).attr("data-user-id");!1===s&&(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"openUserRolesBox",nonce:wpss_user_management_object.nonce,user_id:e},beforeSend:function(){a.addClass("wpss-role-editor-loading")},success:function(e){a.append(e)},complete:function(){s=!1,a.removeClass("wpss-role-editor-loading")},error:function(e){console.log(e)}}))}),a.on("submit",".wpss-user-roles-box form",function(e){e.preventDefault();e=o(this).closest(".wpss-user-roles-box").find(".wpss-user-name span").attr("data-user-id");!1===s&&(s=!0,o.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_set_user_roles_action",nonce:wpss_user_management_object.nonce,user_id:e,user_roles:o(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")},complete:function(){window.location.reload()},error:function(e){console.log(e)}}))}),a.on("click",".wpss-close-roles-box",function(e){e.preventDefault(),o(this).closest(".wpss-user-roles-box").next(".wpss-overlay").remove(),o(this).closest(".wpss-user-roles-box").remove()})});
...
"use strict";jQuery(function(s){let n=wpss_user_management_object.ajax_url,t=wpss_user_management_object.nonce,o=!1,a=s("body");a.on("submit",".wpss-settings-tab-form",function(e){e.preventDefault(),!1===o&&(o=!0,s.ajax({url:n,method:"POST",data:{action:"saveSettings",nonce:t,settings:s(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")},success:function(e){a.find(".settings-message").removeClass("d-none"),a.on("click",".settings-message",function(){s(this).addClass("d-none")})},complete:function(){o=!1,a.removeClass("wpss-role-editor-loading")}}))})});

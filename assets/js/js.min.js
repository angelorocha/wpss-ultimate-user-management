jQuery(function(t){let s=!1;var e=t(".wpss-menage-admin-menus");let n=t(".role-editor-messages");var o=t("#select-all");let a=t("body");t("#wpss-roles-list").select2(),e.on("submit",function(e){e.preventDefault(),s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"menage_admin_menu_options_action",nonce:wpss_user_management_object.nonce,wpss_admin_menus:t(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){n.removeClass("d-none").addClass("success").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}).error(function(e){n.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),n.on("click",function(){t(this).addClass("d-none")}),o.on("click",function(){t(this).is(":checked")?t(".pages-list").find("input:checkbox").prop("checked",!0):t(".pages-list").find("input:checkbox").prop("checked",!1)});e=t(".form-roles"),o=t(".role-delete");let l=t(".role-delete-confirm-msg"),r=t(".table-container"),i=!1,c=!1,d=!1,u=(o.each(function(){t(this).on("click","span",function(){i=t(this).attr("data-role-name"),c=t(this).attr("data-role-id"),d=t("#role-"+c),l.addClass("show-box"),l.find(".role-name > strong").text(i),t(".table-roles").addClass("move-left"),r.outerHeight()<l.outerHeight()&&r.animate({height:l.outerHeight()},200)})}),l.on("click",".confirm-delete",function(){s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_remove_role_action",nonce:wpss_user_management_object.nonce,role_id:c,role_name:i},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){n.removeClass("d-none").addClass("success").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),d.remove(),l.removeClass("show-box"),t(".table-roles").removeClass("move-left"),r.removeAttr("style")}).error(function(e){n.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),l.on("click",".cancel-delete",function(){l.removeClass("show-box"),t(".table-roles").removeClass("move-left")}),e.on("submit",function(e){e.preventDefault(),s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_add_roles_action",nonce:wpss_user_management_object.nonce,role:t(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){n.removeClass("d-none").addClass("success").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),setTimeout(function(){location.reload()},2e3)}).error(function(e){n.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),t("#wpss-user-select").select2(),null),m=t(".user-details-container"),p=(a.on("click",".wpss-user-edit-link",function(){null===(u=t(this).attr("data-user-id"))||""===u||s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_get_user_details_action",nonce:wpss_user_management_object.nonce,user_id:u},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){m.removeClass("d-none").find("div").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),t("html, body").animate({scrollTop:a.find("#user-details-container").offset().top},1e3)}).error(function(e){m.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),t(".wpss-user-select").on("change","#wpss-user-select",function(){null===(u=t(this).val())||""===u||s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_get_user_details_action",nonce:wpss_user_management_object.nonce,user_id:u},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){m.removeClass("d-none").find("div").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}).error(function(e){m.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),a.on("submit",".wpss-add-role-to-user",function(e){e.preventDefault(),null===u||""===u||s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_set_user_roles_action",nonce:wpss_user_management_object.nonce,user_id:u,user_roles:t(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){""!==e?n.removeClass("d-none").addClass("success").html(e):n.removeClass("d-none").addClass("success").html("No changes made")}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),t('.wpss-add-role-to-user input[type="checkbox"]').each(function(){if(t(this).is(":checked")){let e=t(this).val(),s=t(this).parent().text();t(".table-user-roles tbody tr").each(function(){t(".user-role-"+e)[0]||t(this).parent().append('<tr class="user-role-'+e+'"><td>'+s+"</td></tr>")})}else t(".table-user-roles tbody").find(".user-role-"+t(this).val()).remove()})}).error(function(e){m.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),t("#wpss-role-select").select2(),null),_=t(".wpss-role-caps-container");t(".wpss-role-select").on("change","#wpss-role-select",function(){null===(p=t(this).val())||""===p||s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_get_role_capabilities_action",nonce:wpss_user_management_object.nonce,role_caps:p},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){_.removeClass("d-none").find("div").html(e)}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading"),t(".caps-container").each(function(){t(this).on("click",'strong input[type="checkbox"]',function(){t(this).is(":checked")?t(this).closest("ul").find('input[type="checkbox"]').prop("checked",!0):t(this).closest("ul").find('input[type="checkbox"]').prop("checked",!1)})})}).error(function(e){_.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),a.on("submit",".wpss-add-caps-to-role",function(e){e.preventDefault(),s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"wpss_set_capabilities_to_role_action",nonce:wpss_user_management_object.nonce,role:p,capabilities:t(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){""!==e?n.removeClass("d-none").addClass("success").html(e):n.removeClass("d-none").addClass("success").html("No changes made")}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}).error(function(e){n.removeClass("d-none").addClass("error").html(e.status,e.statusText)}))}),a.on("submit",".wpss-widgets-tab form#wpss-widgets-permissions",function(e){e.preventDefault(),s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"save_widget_options",nonce:wpss_user_management_object.nonce,wpss_widgets:t(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){a.find(".wpss-widget-messages").html(`<div class="role-editor-messages success">${e}</div>`),a.find(".role-editor-messages").on("click",null,function(){t(this).addClass("d-none")})}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}))}),a.on("submit",".wpss-widgets-tab form#wpss-individual-widgets-permissions",function(e){e.preventDefault(),s||(s=!0,t.ajax({url:wpss_user_management_object.ajax_url,type:"POST",cache:!1,data:{action:"save_individual_widgets_permissions",nonce:wpss_user_management_object.nonce,individual_widgets:t(this).serialize()},beforeSend:function(){a.addClass("wpss-role-editor-loading")}}).success(function(e){a.find(".wpss-widget-messages").html(`<div class="role-editor-messages success">${e}</div>`),a.find(".role-editor-messages").on("click",null,function(){t(this).addClass("d-none")})}).complete(function(){s=!1,a.removeClass("wpss-role-editor-loading")}))}),a.on("keyup",".cap-filter",function(){let e=t(this).val(),s=0;t(this).next("div").find("li").each(function(){t(this).text().search(new RegExp(e,"i"))<0?(t(this).hide(),t(this).parent().css("border-bottom","none").css("margin",0).css("padding",0).css("flex","inherit")):(t(this).show(),t(this).parent().removeAttr("style"),s++)})})});

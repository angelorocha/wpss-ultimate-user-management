<?php
/**
 * Handles saving the plugin's general settings.
 *
...
class WPSSPluginSettings {
	...
	/**
	 * Register the settings-save AJAX action.
	 *
	 * @since 1.0.0
	 */
	public function __construct() {
		/** Ajax actions */
		add_action( 'wp_ajax_saveSettings', [ $this, 'save_settings' ] );
		add_action( 'wp_ajax_nopriv_saveSettings', [ $this, 'save_settings' ] );
	}

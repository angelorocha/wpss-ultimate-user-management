<?php
/**
 * Controls per-role visibility of admin and front-end widgets.
 *
...
class WPSSWidgets {
	...
	/**
	 * Register the AJAX actions and the widget display filter.
	 *
	 * @since 1.0.0
	 */
	 ...
	 *
	 * @param string $widget_id Registered widget id.
	 * @return string
	 * @since 1.0.0
	 */
